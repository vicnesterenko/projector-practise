...
def generate_high_scores(rate_csv):
    high_scores = {}  # Dictionary to store the high score for each name
...
def save_highscore_in_csv(high_dict: dict):
    ...
    with open(high_scores, "w", newline="") as csvfile:
        ...
        for name, highest_score in sorted(high_dict.items()):
